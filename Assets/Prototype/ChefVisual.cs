...
public class ChefVisual : MonoBehaviour
{
    ...
    private ChefController controller;               // v2.3: 방향 = 가려는 속도
    ...
    private void LateUpdate()
    {
        ...
        // v2.3: 방향의 근거는 '가려는 속도'(벽에 막힌 축은 0). 위치 변화는 되밀림에 부호가 뒤집혀 "뒤도는" 원인이었다
    ...
    private void SpawnGhost()
    {
        ...
        go.transform.localScale = spriteTf.lossyScale;   // v2.3: 그림 배율 따라
