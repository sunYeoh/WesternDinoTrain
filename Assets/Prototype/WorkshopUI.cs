...
public class WorkshopUI : MonoBehaviour
{
    ...
    public void Close()
    {
        ...
        // 증강 선택창/열람 패널(A10)이 떠 있지 않을 때만 시간 재개
    ...
    private void BuyRepair()
    {
        ...
        // 2026-09-14 (교수 피드백 C4): 전투 중 수리는 횟수·골드를 기록해 런 요약에 남긴다 (설계 판단은 측정 후)
    ...
    private string MaterialKoreanName(MaterialType t) { return MaterialNames.Kor(t); }   // v9.10.1: 재료 이름 한 곳
    ...
    private void BuildUI()
    {
        ...
        Text title = KitchenEventManager.MakeText(band, "Title", "안킬로의 정비소", 28, new Color(0.10f, 0.08f, 0.05f));
        ...
        if (bust != null)
        {
            ...
            bustGo.transform.SetParent(body, false);
            RectTransform brt = bustGo.AddComponent<RectTransform>();
            brt.anchorMin = new Vector2(0f, 1f); brt.anchorMax = new Vector2(0f, 1f); brt.pivot = new Vector2(1f, 1f);
            brt.anchoredPosition = new Vector2(-10f, 0f); brt.sizeDelta = new Vector2(192f, 192f);
