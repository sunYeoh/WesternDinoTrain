...
public static class SpinoBet
{
    ...
    public static void Accept(BetId id)
    {
        ...
        if (id == BetId.Ledger && GameManager.Instance != null)
        {
            ...
            UIManager.Instance?.ShowStatChange("[º£ÆÃ] ÆÇµ· " + GameBalance.BetLedgerStake + "G¸¦ °É¾ú´Ù");
        }
    ...
    private static void GrantReward(BetId bet)
    {
        ...
        switch (bet)
        {
            case BetId.OnTime:
                ...
                Notice("[º£ÆÃ ½Â¸®] Á¤½Ã ¹è½Ä! °ñµå +" + GameBalance.BetOnTimeGold);
                break;
            case BetId.Perfect:
            ...
            case BetId.Feast:
                ...
                Notice("[º£ÆÃ ½Â¸®] ±¾ÁÖ¸° ½ÄÅ¹! Àü Àç·á +" + GameBalance.BetFeastMats
                    + ", ¸í¼º +" + GameBalance.BetFeastFame);
                break;
        }
    ...
    private static void ApplyPenalty(BetId bet)
    {
        ...
        switch (bet)
        {
            ...
            case BetId.Ledger:
                // ÆÇµ·Àº ÀÌ¹Ì ³ª°¬°í, Àç·á Àü Á¾·ù Àý¹Ý ¾Ð·ù
                if (MaterialInventory.Instance != null)
                    foreach (MaterialType t in System.Enum.GetValues(typeof(MaterialType)))
                    {
            ...
            case BetId.Feast:
                ...
                Danger("[º£ÆÃ ÆÐ¹è] ±¾ÁÖ¸° ½ÄÅ¹ - °ÝÆÄ º¸³Ê½º ¸ô¼ö, °ñµå Àý¹Ý ¾Ð·ù!");
                break;
        }
